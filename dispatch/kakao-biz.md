...
|  앱 링크  |                     <ul><li>버튼 클릭 시 앱 Custom Scheme 실행</li><li>Android /Ios 에서 실행할 Custom Scheme 각각 설정 필수</li></ul>                    |
...
|   플러그  |                          <ul><li>버튼 클릭 시 플러그인 제공</li><li>이미지 보안 발송 플러그인, 개인 정보 이용 플러그인, 원클릭 결제 플러그인</li></ul>                          |
...
|  봇키워드 |  BK |        -        |   -  |  -  |                            해당 버튼 텍스트 발송                            |
| 메시지전달 |  MD |        -        |   -  |  -  |                          해당 버튼 텍스트+메시지본문 발                         |
